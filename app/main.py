...
# AI query agent temporarily disabled — re-enable with DATABASE_URL_READONLY set.
...
# app.include_router(ai_query_router, prefix="/api/v1")  # AI agent disabled for now
