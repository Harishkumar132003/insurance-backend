...
--    on a CLAIM_APPROVED / CLAIM_PARTIALLY_APPROVED case). Status is
...
-- 2. Invoice payments (N per invoice; each row carries its own reference_id,
--    UTR / settlement id / etc.).
